...
void rc_bt_step() {
  ...
  if (cmd == 'g') { R_motor = HIGH; L_motor = HIGH; mode = MODE_GO_BACK; }
  else if (cmd == 'b') { R_motor = LOW;  L_motor = LOW;  mode = MODE_GO_BACK; }
  else if (cmd == 'r') { mode = MODE_RIGHT; }
  else if (cmd == 'l') { mode = MODE_LEFT; }
  else if (cmd == 's') { mode = MODE_STOP; }
  else if (cmd == 'q') { mode = MODE_ROT_L; }
  else if (cmd == 'w') { mode = MODE_ROT_R; }
  else { return; }
